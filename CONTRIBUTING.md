# Contributing to done-masonry

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/cherifGsoul/done-masonry) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork done-masonry, you can start by going to its [fork page](https://github.com/cherifGsoul/done-masonry/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/done-masonry
```
